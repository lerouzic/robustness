...
\begin{appendices}
  ...
  \section{}
	...
	\begin{center}
	\includegraphics[width=4cm]{../results/figM-random} \includegraphics[width=4cm]{../results/figM-evolved}
	\end{center}
