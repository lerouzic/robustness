...
%~ \citep{Ste02} { (Interesting) comment on Siegal & Bergman 2002}
...
\begin{figure}[t]
\begin{center}
%~ \includegraphics[width=8cm]{../results/figJ-evolved}
...
\begin{appendices}
  ...
  \section{}
	...
	\begin{adjustwidth}{-1in}{0in}
	\begin{flushright}
	\includegraphics[width=15cm]{../results/figS1}
	\end{flushright}
  ...
  \section{}
	...
	\begin{center}
	\includegraphics[width=6cm]{../results/figS2}
	\end{center}    
	...
	weight of the principal components. All PCs except the last one are robust to sampling size. }
  ...
  \section{}
	...
	\begin{center}
	\includegraphics[width=6cm]{../results/figS4}
	\end{center}
  ...
  \section{}
	...
	\begin{center}
	\includegraphics[width=5cm]{../results/figS6}
	\end{center}
  ...
  \section{}
	...
	\begin{center}
	\includegraphics[width=12cm]{../results/figS8} 
	\end{center}
