...
\begin{figure}[t]
\begin{adjustwidth}{-1in}{0in}
\includegraphics[width=15cm]{results/fig1}
...
Selection on robustness components also lead to an indirect response of all other components, which confirms a general genetic correlation. As expected, the magnitude of the correlated response depends on the correlation across robustness components, as indirect responses ranged from 10\% to 100\% of the direct response. 
...
\begin{appendices}
  ...
  \section{}
	...
	\begin{adjustwidth}{-1in}{0in}
	\includegraphics[width=15cm]{results/figS7} 
