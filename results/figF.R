...
# All sims
plotmat(robindex.Gmatrix.outfile(stab$mean[-1,]), arg1=1, arg2=2, col="blue", col.end="green", var.thresh=1e-20)
...
plotmat(lapply(rownames(stab$mean), function(gg) 
	list(mean=colMeans(do.call(rbind, lapply(listM, function(mm) mm[[gg]]$mean))),
	     ...
	     arg1=3, arg2=4, col="blue", col.end="green", var.thresh=1e-20, asp=1)
